...
/**
 * Criteria class for the {@link com.walshe.multitenant.domain.Business} entity. This class is used
 * in {@link com.walshe.multitenant.web.rest.BusinessResource} to receive all the possible filtering options from
...
public class BusinessCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, slug, createdAt, updatedAt, ownerId, distinct);
    }
